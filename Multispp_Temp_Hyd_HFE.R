...
results <- mclapply(temp_seq, function(te) {
  ...
  out <- Multispp(flow.data = flows$Discharge, temp.data = temps, baselineK = 10000, 
                  ...
                  peaklist = 0.17, peakeach = length(temps$Temperature), stage_output = c("all", "biomass"))
...
write.csv(Multispp_temp_abund, "Multispp_temp_hyd_HFE_abund.csv", row.names = FALSE)
write.csv(Multispp_temp_biomass, "Multispp_temp_hyd_HFE_biomass.csv", row.names = FALSE)
write.csv(MultisppS3_temp_biomass, "MultisppS3_temp_hyd_HFE_biomass.csv", row.names = FALSE)
...
write.csv(Multispp_temp_abund_spike, "Multispp_temp_hyd_HFE_abund_spike.csv", row.names = FALSE)
write.csv(Multispp_temp_biomass_spike, "Multispp_temp_hyd_HFE_biomass_spike.csv", row.names = FALSE)
write.csv(MultisppS3_temp_biomass_spike, "MultisppS3_temp_hyd_HFE_biomass_spike.csv", row.names = FALSE)
