...
#   ylab("Sp C post pulse abundance relative to K")+
#   theme_bw()+
...
# # calculate immediate response to the different magnitudes
# 
# c_S3magnitude_df <- as.data.frame(cbind(magnitudes, immediate_response, rep("C", times = length(immediate_response))))
# c_S3short_df <- as.data.frame(cbind(magnitudes, short_response, rep("C", times = length(immediate_response))))
# 
# 
