...
# write.csv(Multispp_temp_abund, "Multispp_temp_abund_q.csv", row.names = FALSE)
# write.csv(Multispp_temp_biomass, "Multispp_temp_biomass_q.csv", row.names = FALSE)
# write.csv(MultisppS3_temp_biomass, "MultisppS3_temp_biomass_q.csv", row.names = FALSE)
# 
...
write.csv(Multispp_temp_abund_spike, "Multispp_temp_abund_spike_q.csv", row.names = FALSE)
write.csv(Multispp_temp_biomass_spike, "Multispp_temp_biomass_spike_q.csv", row.names = FALSE)
write.csv(MultisppS3_temp_biomass_spike, "MultisppS3_temp_biomass_spike_q.csv", row.names = FALSE)
