...
for (i in 1:length(press_magnitudes)){
  ...
  out <- Cmodel(discharge, temp, baselineK = 10000, disturbanceK = 1000000, Qmin = 0.25, extinct = 50, iteration = 2, peaklist = press_magnitudes[i], peakeach = length(temp$Temperature))
