###################
## Multispp Sensitivity Flood Mortality
##################
library(ggplot2)
library(dplyr)
...
parameters <- c("flood.mort_HYOS", "flood.mort_BAET", "flood.mort_CHIR", "flood.mort_NZMS", "flood.mort_GAMM")
...
# Save to CSV
write.csv(final_results, "Multispp_mF_sens_temps_hfe.csv", row.names = FALSE)
