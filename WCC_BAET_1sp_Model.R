...
# 
par(mfrow = c(1,1))
plot(timestep[15:(length(timestep)+1)], output.N.list[15:(length(timestep)+1), 3, 1], type = "l", ylab = "Baetis spp. Adults", xlab = "Timestep (1 fortnight)")
plot(timestep[15:length(timestep)], Total.N[16:(length(timestep)+1)], type= "l", ylab = "Baetis spp. Total N", xlab = "Timestep (1 fortnight)")
