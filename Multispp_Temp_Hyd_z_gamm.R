...
write.csv(Multispp_temp_abund, "Multispp_temp_abund_hyd_z_gamm_full.csv", row.names = FALSE)
write.csv(Multispp_temp_biomass, "Multispp_temp_biomass_hyd_z_gamm_full.csv", row.names = FALSE)
write.csv(MultisppS3_temp_biomass, "MultisppS3_temp_hyd_z_gamm.csv", row.names = FALSE)
...
# Write results to CSV files
write.csv(Multispp_temp_abund, "Multispp_temp_abund_hyd_z_gamm.csv", row.names = FALSE)
write.csv(Multispp_temp_biomass, "Multispp_temp_biomass_hyd_z_gamm.csv", row.names = FALSE)
...
write.csv(MultisppS3_temp_biomass_spike, "MultisppS3_temp_hyd_biomass_spike_z_gamm.csv", row.names = FALSE)
...
write.csv(Multispp_temp_abund_spike, "Multispp_temp_hyd_abund_spike_z_gamm.csv", row.names = FALSE)
write.csv(Multispp_temp_biomass_spike, "Multispp_temp_hyd_biomass_spike_z_gamm.csv", row.names = FALSE)
