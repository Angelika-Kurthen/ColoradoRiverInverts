...
write.csv(Multispp_temp_abund, "Multispp_temp_hyd_HFE_abund_z_full.csv", row.names = FALSE)
write.csv(Multispp_temp_biomass, "Multispp_temp_hyd_HFE_biomass_z_full.csv", row.names = FALSE)
write.csv(MultisppS3_temp_biomass, "MultisppS3_temp_hyd_HFE_biomass_z.csv", row.names = FALSE)
...
# Write results to CSV files
write.csv(Multispp_temp_abund, "Multispp_temp_hyd_HFE_abund_z.csv", row.names = FALSE)
...
# 
# 
# write.csv(Multispp_temp_abund_spike, "Multispp_temp_hyd_HFE_abund_spike_z_full.csv", row.names = FALSE)
# write.csv(Multispp_temp_biomass_spike, "Multispp_temp_hyd_HFE_biomass_spike_z_full.csv", row.names = FALSE)
# write.csv(MultisppS3_temp_biomass_spike, "MultisppS3_temp_hyd_HFE_biomass_spike_z.csv", row.names = FALSE)
# 
