...
#library(car)
library(boot)
GAMMVitalRates <- read_excel("ColoradoRiverInvertsMultiTaxa/Data/VitalRates.xlsx", sheet = "Gammarus Mortality Rates")
...
GAMMSurvRates <- read_excel("ColoradoRiverInvertsMultiTaxa/Data/VitalRates.xlsx", sheet = "Gammarus Survival Rates")
