...
#library(car)
library(boot)
NZMSVitalRates <- read_excel("ColoradoRiverInvertsMultiTaxa/Data/VitalRates.xlsx", sheet = "NZMS Mortality Rates")
...
NZMSSurvRates <- read_excel("ColoradoRiverInvertsMultiTaxa/Data/VitalRates.xlsx", sheet = "NZMS Survival Rates")
