...
BAETVitalRates <- read_excel("ColoradoRiverInvertsMultiTaxa/Data/VitalRates.xlsx", sheet = "Baetid Mortality Rates")
...
BAETDevRates <- read_excel("ColoradoRiverInvertsMultiTaxa/Data/VitalRates.xlsx", sheet = "Baetid Development")
...
BAETSurvRate <- read_excel("ColoradoRiverInvertsMultiTaxa/Data/VitalRates.xlsx", sheet = "Baetid Survival Rates")
