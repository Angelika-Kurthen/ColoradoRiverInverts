...
#library(car)
library(boot)
CHIRVitalRates <- read_excel("ColoradoRiverInvertsMultiTaxa/Data/VitalRates.xlsx", sheet = "Chiro Mortality Rates")
...
CHIRSurvRate <- read_excel("ColoradoRiverInvertsMultiTaxa/Data/VitalRates.xlsx", sheet = "Chiro Survival")
