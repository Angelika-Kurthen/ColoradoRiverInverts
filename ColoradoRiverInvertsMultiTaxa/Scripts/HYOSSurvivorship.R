...
library(boot)
library(data.table)
HYOSVitalRates <- read_excel("ColoradoRiverInvertsMultiTaxa/Data/VitalRates.xlsx", sheet = "Hydropsyche Mortality Rates")
...
HYOSDevRates <- read_excel("ColoradoRiverInvertsMultiTaxa/Data/VitalRates.xlsx", sheet = "Hydropsyche Development Rates")
...
# 
HYOSSurvRates <- read_excel("ColoradoRiverInvertsMultiTaxa/Data/VitalRates.xlsx", sheet = "Hydropsyche Survival Rates ")
