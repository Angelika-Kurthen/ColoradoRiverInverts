...
results <- mclapply(temp_seq, function(te) {
  ...
  temp_results <- lapply(q_seq, function(q_val) {
    ...
    # Modify inputs
    qs <- list(HYOS = 1, BAET = 1, NZMS = 1, CHIR = q_val, GAMM = 1)
...
write.csv(Multispp_temp_abund, "Multispp_temp_hyd_HFE_abund_z_chir_full.csv", row.names = FALSE)
write.csv(Multispp_temp_biomass, "Multispp_temp_hyd_HFE_biomass_z_chir_full.csv", row.names = FALSE)
write.csv(MultisppS3_temp_biomass, "MultisppS3_temp_hyd_HFE_biomass_z_chir.csv", row.names = FALSE)
...
# Write results to CSV files
write.csv(Multispp_temp_abund, "Multispp_temp_hyd_HFE_abund_z_chir.csv", row.names = FALSE)
write.csv(Multispp_temp_biomass, "Multispp_temp_hyd_HFE_biomass_z_chir.csv", row.names = FALSE)
...
write.csv(Multispp_temp_abund_spike, "Multispp_temp_hyd_HFE_abund_spike_z_chir_full.csv", row.names = FALSE)
write.csv(Multispp_temp_biomass_spike, "Multispp_temp_hyd_HFE_biomass_spike_z_chir_full.csv", row.names = FALSE)
write.csv(MultisppS3_temp_biomass_spike, "MultisppS3_temp_hyd_HFE_biomass_spike_z_chir.csv", row.names = FALSE)
...
write.csv(Multispp_temp_abund_spike, "Multispp_temp_hyd_HFE_abund_spike_z_chir.csv", row.names = FALSE)
write.csv(Multispp_temp_biomass_spike, "Multispp_temp_hyd_HFE_biomass_spike_z_chir.csv", row.names = FALSE)
