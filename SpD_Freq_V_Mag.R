...
d_immediate_df <- pivot_longer(immediate_df, cols = 1:length(magnitudes), names_to = "magnitude", values_to = "abundance")
d_immediate_df$magnitude <- as.numeric(d_immediate_df$magnitude)
write.csv(d_immediate_df, file = "SpD_FreqVMag_immediate.csv")
# 
...
d_short_df <- pivot_longer(short_df, cols = 1:length(magnitudes), names_to = "magnitude", values_to = "abundance")
d_short_df$magnitude <- as.numeric(d_short_df$magnitude)
write.csv(d_short_df, file = "SpD_FreqVMag_short.csv")
...
d_long_df <- pivot_longer(long_df, cols = 1:length(magnitudes), names_to = "magnitude", values_to = "abundance")
d_long_df$magnitude <- as.numeric(d_long_df$magnitude)
write.csv(d_long_df, file = "SpD_FreqVMag_long.csv")
