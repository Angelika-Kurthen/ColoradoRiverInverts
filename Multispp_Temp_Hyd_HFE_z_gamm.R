...
results <- mclapply(temp_seq, function(te) {
  ...
  temp_results <- lapply(q_seq, function(q_val) {
    ...
    # Modify inputs
    qs <- list(HYOS = 1, BAET = 1, NZMS = 1, CHIR = 1, GAMM = q_val)
...
write.csv(Multispp_temp_abund, "Multispp_temp_hyd_HFE_abund_z_gamm_full.csv", row.names = FALSE)
write.csv(Multispp_temp_biomass, "Multispp_temp_hyd_HFE_biomass_z_gamm_full.csv", row.names = FALSE)
write.csv(MultisppS3_temp_biomass, "MultisppS3_temp_hyd_HFE_biomass_z_gamm.csv", row.names = FALSE)
...
Multispp_temp_abund <- Multispp_temp_abund %>%
    ...
    summarise(mean_abund = mean(abundance, na.rm = T),
            sd_abund = sd(abundance, na.rm = T), .groups = "drop")

# Write results to CSV files
write.csv(Multispp_temp_abund, "Multispp_temp_hyd_HFE_abund_z_gamm.csv", row.names = FALSE)
write.csv(Multispp_temp_biomass, "Multispp_temp_hyd_HFE_biomass_z_gamm.csv", row.names = FALSE)
...
write.csv(Multispp_temp_abund_spike, "Multispp_temp_hyd_HFE_abund_spike_z_gamm_full.csv", row.names = FALSE)
write.csv(Multispp_temp_biomass_spike, "Multispp_temp_hyd_HFE_biomass_spike_z_gamm_full.csv", row.names = FALSE)
write.csv(MultisppS3_temp_biomass_spike, "MultisppS3_temp_hyd_HFE_biomass_spike_z_gamm.csv", row.names = FALSE)
...
write.csv(Multispp_temp_abund_spike, "Multispp_temp_hyd_HFE_abund_spike_z_gamm.csv", row.names = FALSE)
write.csv(Multispp_temp_biomass_spike, "Multispp_temp_hyd_HFE_biomass_spike_z_gamm.csv", row.names = FALSE)
