...
# Combine results from all temperature scenarios into final dataframes
NZMS_temp_hyd_abund <- do.call(rbind, lapply(results, `[[`, "NZMS_temp_hyd_abund_spike"))
NZMS_temp_hyd_biomass <- do.call(rbind, lapply(results, `[[`, "NZMS_temp_hyd_biomass_spike"))
